...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOL] = LAYOUT_planck_grid(
            ...
            KC_EQL,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_BSLS, KC_PIPE,
            KC_TILD, KC_MINS, KC_PLUS, KC_ASTR, KC_SLSH, KC_AMPR, KC_LCBR, KC_RCBR, KC_LT,   KC_GT,   KC_UNDS, KC_COLN,
    ...
    [_ADJUST] = LAYOUT_planck_grid(
            ...
            LOCK,    RGB_SAI, RGB_SAD, _______, DM_PLY1, _______, _______, _______, _______, CAP_LST, CAP_IMG, CAP_MOV,
            QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, COPYADDR,KC_MPLY, _______,
